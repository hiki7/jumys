...
class CustomUserAdmin(UserAdmin):
    model = CustomUser
    list_display = ('email', 'first_name', 'last_name', 'is_manager', 'date_joined')
    list_filter = ('is_manager',)  # Ensure this is a tuple by adding a comma
    ordering = ('email',)
    ...
    fieldsets = (
        ...
        ('Permissions', {'fields': ('is_manager', 'is_superuser', 'groups', 'user_permissions')}),

...
urlpatterns = [
    ...
    path('profile/abilities/', AbilityListCreateView.as_view(), name='ability_list_create'),
    path('profile/work-experience/', WorkExperienceListCreateView.as_view(), name='work_experience_list_create'),
]
